...
import { Archive, Check, CircleAlert, Download, Layers, LayoutDashboard, Palette, Upload, X } from 'lucide-react';
...
const SettingsModal = ({ onClose }: SettingsModalProps) => {
  ...
  const { boards, currentBoardId, switchBoard, createBoard } = useBoards();
            ...
            {currentTab === 'boards' && (
              <div className="space-y-4">
                ...
                <div className="text-sm text-theme-muted">
                  ...
                  <br/>
                  <span className="italic text-theme-primary">Click on a board above to switch to it.</span>
                </div>
              </div>
            )}
